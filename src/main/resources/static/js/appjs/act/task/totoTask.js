				...
				columns : [
                    ...
                    },
                    {
						...
						formatter:function(value,row,index){
                        	// return '<a href="/activiti/task/trace/photo/'+row.processDefinitionId+'/'+row.executionId+'"  target="_blank">跟踪</a>';
                            return '<a href="#" title="跟踪" mce_href="#" onclick="trace(\''
...
function trace(proId,id) {
    layer.open({
        ...
        shadeClose : false,
        area : [ '100%', '100%' ],
        content : '/activiti/task/trace/photo/'+ proId+'/'+id
    })
}
